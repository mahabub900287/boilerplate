<x-admin.layouts.app :title="getbreadcumb()">
    <div class="ic-user">
        ...
        <x-form method="PUT" action="{{ route('admin.new-admin.update', $item->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="ic-profile-content">
                                ...
                                <select class="ic-select" name="role" aria-label="Select Role"
                                    ...
                                    @forelse ($roles as $role)
                                        <option value="{{ $role->name }}"
                                            {{ $item->getRoleNames()->contains($role->name) ? 'selected' : '' }}>
                                            {{ $role->name }}
                                        </option>
                                    @empty
                        ...
                        <div class="ic-button-wrapper d-flex justify-content-end">
                            <div class="right-button-group ">
                                <a href="{{ route('admin.new-admin.index') }}" class="ic-button white">Cancel</a>
